                  ...
                  >
                    ...
                    {sub.isEvaluatedByScore ? (
                      <>
                        ...
                        <td className={`px-2 py-2 font-bold border-r border-slate-300 transition-colors ${term === "hk1" ? "bg-amber-100/60 text-slate-950 font-black text-base" : "text-slate-900 bg-slate-50/80"}`}>
                          {typeof sub.semester1 === "number" ? sub.semester1.toFixed(1) : sub.semester1 || "-"}
                        </td>
                      </>
                    ) : (
                    ...
                    {sub.isEvaluatedByScore ? (
                      <>
                        ...
                        <td className={`px-2 py-2 font-bold border-r border-slate-300 transition-colors ${term === "hk2" ? "bg-amber-100/60 text-slate-950 font-black text-base" : "text-slate-900 bg-slate-50/80"}`}>
                          {typeof sub.semester2 === "number" ? sub.semester2.toFixed(1) : sub.semester2 || "-"}
                        </td>
                      </>
                    ) : (
                    ...
                    {/* Year Average (Cả năm) */}
                    <td className={`px-2 py-2 font-black text-white text-center w-24 border-none text-[13px] transition-all ${
