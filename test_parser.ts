  ...
  const textToParse = `
ỦY BAN NHÂN DÂN XÃ XA DUNG	TRƯỜNG PTDTBT TIỂU HỌC VÀ THCS SUỐI LƯ	KẾT QUẢ HỌC TẬP Học kỳ 1, Năm học 2025 - 2026	Mã HS : 2307930338	Họ và tên: Nguyễn Bảo An Lớp: 6A1	TT	Môn học	ĐĐGtx	ĐĐGgk	ĐĐGck	TB	1	Toán học	9 8 7 9	8	8.0	8,1	2	Lịch sử và Địa lí	10 9 9 8	9.5	8.3	8,9
`.replace(/	/g, '	').replace(/
/g, '
');
